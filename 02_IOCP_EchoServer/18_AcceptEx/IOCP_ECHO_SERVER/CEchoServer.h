...
public:
	...
	void OnRecv(const UINT64 sessionID, CSerializableBufferView<TRUE> *message); // 패킷 수신 완료 후
	void OnRecv(const UINT64 sessionID, CSmartPtr<CSerializableBufferView<TRUE>> message);
