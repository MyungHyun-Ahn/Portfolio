...
private:
	...
	inline static MHLib::memory::CTLSMemoryPoolManager <CSerializableBufferView, 128, 4, false> s_sbufferPool = MHLib::memory::CTLSMemoryPoolManager <CSerializableBufferView, 128, 4, false>();
};
