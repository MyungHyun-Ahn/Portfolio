...
enum en_PACKET_SS_MONITOR_DATA_UPDATE
{
	...
	dfMONITOR_DATA_TYPE_GAME_SERVER_RUN = 10,		// 게임서버 실행 여부 ON / OFF
	dfMONITOR_DATA_TYPE_GAME_SERVER_CPU = 11,		// 게임서버 CPU 사용률
	dfMONITOR_DATA_TYPE_GAME_SERVER_MEM = 12,		// 게임서버 메모리 사용 MByte
	dfMONITOR_DATA_TYPE_GAME_SESSION = 13,			// 게임서버 세션 수 (커넥션 수)
	...
	dfMONITOR_DATA_TYPE_GAME_PACKET_RECV_TPS = 17,	// 게임서버 RECV TPS
	dfMONITOR_DATA_TYPE_GAME_PACKET_SEND_TPS = 18,	// 게임서버 SEND TPS
	...
	dfMONITOR_DATA_TYPE_CHAT_SERVER_RUN = 30,		// 채팅서버 실행 여부 ON / OFF
	...
	dfMONITOR_DATA_TYPE_CHAT_PLAYER = 34,			// 채팅서버 플레이어 수
	dfMONITOR_DATA_TYPE_CHAT_UPDATE_TPS = 35,		// 채팅서버 UPDATE TPS
