...
#pragma warning(disable : 6387) // ConnectEx Param 경고
	...
	public:
		...
		friend class CNetClientManager;
	...
	public:
		...
		BOOL ConnectExCompleted(CNetSession *pSession) noexcept;
	...
	public:
		...
		inline void RegisterClient(CNetClient *client) noexcept
		{
	...
	private:
		...
		INT m_ClientSize = 0;
		std::vector<CNetClient *>		m_arrNetClients;
		HANDLE							m_hIOCPHandle = INVALID_HANDLE_VALUE;
	};

	extern CNetClientManager *g_netClientMgr;
}